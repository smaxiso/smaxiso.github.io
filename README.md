...
Welcome to my professional portfolio! This repository showcases a modern, Material Design 3-inspired website built with vanilla HTML, CSS, and JavaScript. It features my professional experience at **Gen Digital** and **TCS**, academic projects, and side ventures.
...
| 📊 **Dynamic Content** | JSON-driven project and skills management |
| 🔍 **SEO Ready** | Semantic HTML with proper meta tags |
| ♿ **Accessible** | ARIA labels and keyboard navigation |
| 📧 **Contact Form** | Integrated Formspree contact functionality |

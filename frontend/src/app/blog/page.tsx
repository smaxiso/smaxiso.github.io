                    ...
                    <div className="grid gap-8">
                        {posts.map((post, index) => (
                            <motion.article
                                ...
                                className="group"
                            >
                                <Link href={`/blog/${post.slug}`} className="block glass-card p-4 md:p-8 rounded-2xl hover:bg-white/60 transition-all border border-white/50 hover:shadow-lg">
                                    <div className="flex flex-col-reverse md:flex-row md:items-start gap-4 md:gap-6">
                                        <div className="flex-1 space-y-3">
                                            ...
                                            <div className="pt-2 text-blue-600 font-medium text-sm md:text-base flex items-center gap-1 group-hover:gap-2 transition-all">

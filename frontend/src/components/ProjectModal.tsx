                ...
                <>
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="w-full max-w-4xl h-full sm:h-auto sm:max-h-[85vh] bg-white rounded-none sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col glass-card border-0 sm:border border-white/20 relative"
                        >
                            {/* Close Button */}
                            <button
                                onClick={onClose}
                                ...
                                <div className="p-6 sm:p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                                    ...
                                    <div className="md:col-span-2 space-y-6">
                                        ...
                                        <div className="flex flex-wrap items-center gap-3">
                                            ...
                                            {project.start_date && (
                                                <div className="flex items-center gap-1 text-xs sm:text-sm text-slate-500 bg-slate-100 px-3 py-1 rounded-full border border-slate-200">
                                                    <Calendar size={14} />
                                                    <span>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {project.technologies.map((tech) => (
                                                    <span
                                                        key={tech}
                                                        className="px-3 py-1.5 bg-slate-100 text-slate-700 text-sm font-medium rounded-lg border border-slate-200 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200 transition-colors"
                                                    >
                                                        {tech}
                                                    </span>
                                                ))}
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                {project.github_url && (
                                                    <a
                                                        ...
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className="flex items-center justify-center gap-2 w-full py-3 bg-white text-slate-700 border border-slate-200 rounded-xl font-medium hover:bg-slate-50 hover:text-black transition-all"
                                                    >
                                                        <Github size={18} />
                                                        View Code
                                                    </a>

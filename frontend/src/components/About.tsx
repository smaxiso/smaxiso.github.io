                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4 sm:gap-6 pt-2">
                            {siteConfig.about.stats.map(stat => (
                                <div key={stat.label} className="text-center p-4 sm:p-6 bg-white/50 backdrop-blur-sm rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-shadow group">

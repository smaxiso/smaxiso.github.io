            ...
            <div className="container px-4 md:px-6 relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-purple-500/10 dark:from-blue-500/20 dark:to-purple-500/20 rounded-3xl blur-2xl" />
                        <div className="relative bg-white dark:bg-gradient-to-br dark:from-slate-800/80 dark:to-blue-900/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-slate-200 dark:border-blue-400/30">
                            <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-3xl opacity-10 dark:opacity-20 blur-xl animate-pulse" />
                            ...
                            <div className="relative">
                                <ResponsiveContainer width="100%" height={450}>
                                    <RadarChart data={animatedData}>
                                        ...
                                        <PolarGrid
                                            stroke="#cbd5e1"
                                            className="dark:stroke-blue-400/30"
                                            strokeDasharray="3 3"
                                            strokeOpacity={0.5}
                                        />
                                        <PolarAngleAxis
                            ...
                            {Array.from(new Set(skills.map(s => s.category))).map((category, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="relative bg-slate-50 dark:bg-slate-800/60 backdrop-blur-sm p-5 rounded-xl border border-slate-200 dark:border-slate-700/50 group-hover:border-blue-400/50 transition-all shadow-lg">
                                            <div className="flex items-center justify-between mb-3">
                                                <h4 className="font-bold text-slate-900 dark:text-white text-lg group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors flex items-center gap-2">
                                                    {category}
                                                    {isSelected && <Sparkles className="w-4 h-4 text-yellow-500 dark:text-yellow-400 animate-spin" />}
                                                </h4>
                                                <motion.span
                                                    className="text-lg font-bold bg-gradient-to-r from-blue-600 to-cyan-600 dark:from-blue-400 dark:to-cyan-400 bg-clip-text text-transparent"
                                            ...
                                            <div className="h-3 bg-slate-200 dark:bg-slate-700/50 rounded-full overflow-hidden mb-3 relative">
                                                <motion.div
                                                    initial={{ width: 0 }}
                                                ...
                                                {(isSelected || !selectedCategory) && (
                                                    ...
                                                    >
                                                        ...
                                                        {!isSelected && categorySkills.length > 6 && (
                                                            <span className="text-xs px-3 py-1.5 text-blue-600 dark:text-blue-300 font-medium">

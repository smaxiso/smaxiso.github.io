...
export default function ExperienceEditor() {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Form */}
            {showForm && (
                <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 p-6 rounded-lg border space-y-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                placeholder="2025-12 or leave empty"
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            placeholder="https://... or Cloudinary public_id"
            ...
            {loading ? (
                ...
                <div className="space-y-4">
                    {experiences.map((exp) => (
                        <div
                            key={exp.id}
                            className="bg-white dark:bg-slate-800 p-4 rounded-lg border flex justify-between items-start"
                        >
                            <div>
